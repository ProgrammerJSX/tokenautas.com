...
/* Asegúrate de que las nuevas clases no estén sobreescribiendo propiedades de las clases antiguas si no es intencional */
      ...
      <p class="main__sub" style="font-size: 25px;"><span>RED:</span>TRC20<span></span></p>
      <?php
...
<div class="main__list-heading-wrap">
         <div id="johan" class="modal-bitcoin" >  <!-- OJO -->
            ...
            <p> <span style="opacity: 0;">Imagen BTC:</span> <img  width="400" src="<?php echo '../' . htmlspecialchars($imagenUSD); ?>" alt="Imagen USD"></p>
            </div>
...
<div class="main__list-content-wrap">
  <p class="main__list-content" style="padding-bottom: 50px ;" ><?php echo $valorWalletUSDT; ?></p>
  <p class="main__list-sub" style="  padding-bottom: 50px ;">Tu billetera USDT</p>
</div>
...
<div id="dis" class="disclamerMobile1" style="background-color: white; box-shadow: 10px 15px 10px black; border-radius:5px; width:100%; text-align: center; align-items:center; justify-content: center; display: flex; flex-direction:column"> <p style="color: #333; padding:20px" class="original">Descargo de responsabilidad: Depositos en USDT de la red TRC20

Por favor, tenga en cuenta que los depósitos realizados en USDT de la red TRC20 deben ser realizados con precaución y entendimiento pleno de los riesgos asociados. Activos Digitales no se hace responsable de pérdidas, retrasos o cualquier otro inconveniente causado por depósitos en USDT de la red TRC20

<span class="dots">...</span>

<p style="color: #333; padding:20px" class="extra" id="hideText">
Recomendamos encarecidamente verificar la dirección del monedero y confirmar la compatibilidad con la red TRC20 antes de realizar cualquier depósito. Además, le recomendamos que se informe sobre los procedimientos de seguridad adecuados para el almacenamiento y la gestión de criptomonedas.</p>
