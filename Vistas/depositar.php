...
<!-- MAIN -->
        <main class="main">
          ...
          <div class="main__col-1">
            ...
            <ul class="main__list">
              ...
              <li class="main__list-item">
                ...
                <div class="main__list-content-wrap" style="opacity: 0;">
                  <p class="main__desc" style="font-weight: bold; color: white !important;">Bienvenido! Aqui podras vender tus tokens o recibir tus criptomonedas  rapido y seguro^_^</p>
          ...
          <div class="main__col-2">
            ...
            <!-- CROSSING -->
            <div class="main__crossing-container" style="opacity: 0;">
            ...
            <div class="main__discover plataformas3x" style=" width: 150%; max-width:150% ; margin-left: -380px; background: transparent !important;">

              <div class="main__discover-heading-container" style="display: none;">
                <h3 class="main__discover-heading ss-heading">SELECCIONA TU PLATAFORMA</h3>
                <a href="#" class="ss-show">Ver Todas Las Plataformas</a>
              </div>

              <ul class="main__discover-places" style="margin-left: 0;">

                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">BongaCams</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">bongacams.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;">
                    <img src="./plataformas/wc BG-02.png" width="90" alt="">
                       <defs>
                    ...
                    <span class="ss-dots" style="display: none;">
                      <span></span>
                      <span></span>
                      <span></span>
                    </span>
                ...
                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">Chaturbate</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">chaturbate.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;" >
                    <img src="./plataformas/wc chaturbate-01.png" width="117" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
                ...
                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">CamSoda</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">camsoda.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;">
                    <img src="./plataformas/wc camsoda-07.png" width="120" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
                ...
                <li class="main__discover-place cocacola">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">XvideosCams</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">xvideoscam.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;" >
                    <img src="./plataformas/wc x videos-09.png" width="120" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
              ...
              <ul class="main__discover-places" style="margin-right: 80px;" >

                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">Cam4</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">cam4.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;">
                    <img src="../plataformas/cam4.png" width="90" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
                ...
                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">Stremeate</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">stremeate.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;" >
                    <img src="../plataformas/stremeate.png" width="117" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
                ...
                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">ManyVids</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">manyvids.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;">
                    <img src="../plataformas/manyvids.png" width="120" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
                ...
                <li class="main__discover-place">
                  <h4 class="main__discover-place-heading" style="font-weight: bold;">StripChat</h4>
                  <p class="main__discover-place-sub" style="font-size: 14px;">stripchat.com</p>
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style="display: flex;  width: 100%;" >
                    <img src="../plataformas/stripchat.png" width="120" alt="">
                       <defs>
                          <linearGradient id="myGradient1" gradientTransform="rotate(20)">
                            <stop offset="0%" stop-color="hsl(0, 60%, 50%)" />
                            <stop offset="50%" stop-color="hsl(20, 60%, 50%)" />
