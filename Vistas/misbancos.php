...
<html lang="en">
  ...
  <head>
    ...
    <title>Tokenautas Mis Bancos</title>
        ...
        <main class="main">
          ...
          <div class="main__col-1">
            ...
            <div>
              ...
              <p class="main__sub" style="padding-top: 20px !important;"><span style="font-size: 50px;">Saldo:</span> <span style="font-size: 50px;">$<?php echo $miBilletera1; ?> COP</span></p>
            </div>
          ...
          <div class="main__col-2">
            ...
            <!-- DISCOVER -->
            <div class="main__discover" style="height: 70vh;">

              <div class="main__discover-heading-container">
                <h3 class="main__discover-heading ss-heading">DATOS BANCARIOS:</h3>
                <a href="#" class="ss-show">¿Aun no registras un banco? <br>
              <span style="font-weight: bold;"> ¡Haz clic aqui para registrarlo! </span></a>
              </div>
