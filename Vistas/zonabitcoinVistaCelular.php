...
/* Asegúrate de que las nuevas clases no estén sobreescribiendo propiedades de las clases antiguas si no es intencional */
      ...
      <p class="main__sub" style="font-size: 25px;"><span>BTC</span> <span></span></p>
      <?php
...
<div class="main__list-content-wrap">
  <p class="main__list-content" style="padding-bottom: 50px ;" ><?php echo $valorWalletBTC; ?></p>
  <p class="main__list-sub" style="  padding-bottom: 50px ;">Tu billetera Bitcoin</p>
</div>
<script>
...
<div id="dis" class="disclamerMobile1" style="background-color: white; box-shadow: 10px 15px 10px black; border-radius:5px; width:100%; text-align: center; align-items:center; justify-content: center; display: flex; flex-direction:column"> <p style="color: #333; padding:20px" class="original">Descargo de responsabilidad: Depósitos en Bitcoin (BTC)

Por favor, tenga en cuenta que los depósitos realizados en Bitcoin (BTC) deben ser realizados con precaución y entendimiento pleno de los riesgos asociados. Activos Digitales no se hace responsable de pérdidas, retrasos o cualquier otro inconveniente causado por depósitos en Bitcoin (BTC)
